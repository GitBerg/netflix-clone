...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
    ...
    return(
        <div className="group bg-zinc-900 cal-span relative h-[12vw">
            <Image height={500} width={500} src={data.thumbnailUrl} alt="Thumbnail" className="cursor-pointer object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-[12vw]"/>
