...
const Navbar = () => {
    ...
    const [showBackgroung, setShowBackground] = useState(false)
    ...
    return (
        <nav className="w-full fixed z-40">
            <div className={`
                ...
                transition
                duration-500
                ${showBackgroung ? 'bg-zinc-900 bg-opacity-90' : ''}
            `}>
                <Image height={500} width={120} src="/images/logo.png" alt="logo" className="h-4 w-24 sm:w-28 lg:h-7" />
                <div className="
                    flex-row
                    ml-8
                    gap-7
                ...
                <div className="flex flex-row ml-auto gap-7 items-center">
                    ...
                    <div onClick={toogleAccountMenu} className="flex flex-row items-center gap-2 cursor-pointer relative">
                        <div className="w-6 h-6 lg:w-10 lg:h-10 rounded-md overflow-hidden">
                            <Image height={0} width={0} src="/images/default-blue.png" alt="profile" />
                        </div>
